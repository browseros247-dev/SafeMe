...
| Backup & Restore | Versioned, human-editable JSONC file capturing all 7 config domains; atomic validate-before-write restore with rollback | Profile → Backup & Restore |
