 ...
 * Shopping, Shipping & Payment, Games, News & Productivity — with an [OTHER]
 * fallback for apps that can't be classified.
 */
enum class AppCategory(val labelRes: Int) {
    ...
    SHIPPING_PAYMENT(R.string.app_cat_shipping_payment),
...
object AppCatalog {
    ...
    private val packageRules: List<Pair<String, AppCategory>> = buildList {
        ...
        // Shipping & Payment (delivery/courier and money apps).
        add("com.paypal.android.p2pmobile" to AppCategory.SHIPPING_PAYMENT)
        add("com.venmo" to AppCategory.SHIPPING_PAYMENT)
        add("com.squareup.cash" to AppCategory.SHIPPING_PAYMENT)
        add("com.google.android.apps.walletnfcrel" to AppCategory.SHIPPING_PAYMENT)
        add("com.google.android.apps.nbu.paisa.user" to AppCategory.SHIPPING_PAYMENT)
        add("com.phonepe.app" to AppCategory.SHIPPING_PAYMENT)
        add("net.one97.paytm" to AppCategory.SHIPPING_PAYMENT)
        add("com.revolut" to AppCategory.SHIPPING_PAYMENT)
        add("transferwise" to AppCategory.SHIPPING_PAYMENT)
        add("com.monzo" to AppCategory.SHIPPING_PAYMENT)
        add("co.banking.android" to AppCategory.SHIPPING_PAYMENT)
        add("com.doordash" to AppCategory.SHIPPING_PAYMENT)
        add("com.ubercab.eats" to AppCategory.SHIPPING_PAYMENT)
        add("com.deliveroo" to AppCategory.SHIPPING_PAYMENT)
        add("com.justeat" to AppCategory.SHIPPING_PAYMENT)
        add("com.grubhub" to AppCategory.SHIPPING_PAYMENT)
        add("com.postmates" to AppCategory.SHIPPING_PAYMENT)
        add("com.instacart" to AppCategory.SHIPPING_PAYMENT)
        add("com.fedex" to AppCategory.SHIPPING_PAYMENT)
        add("com.ups.mobile.android" to AppCategory.SHIPPING_PAYMENT)
        add("com.dhl" to AppCategory.SHIPPING_PAYMENT)
        add("com.usps" to AppCategory.SHIPPING_PAYMENT)
    ...
    private val labelRules: List<Pair<String, AppCategory>> = buildList {
        ...
        add("paypal" to AppCategory.SHIPPING_PAYMENT)
        add("venmo" to AppCategory.SHIPPING_PAYMENT)
        add("cash app" to AppCategory.SHIPPING_PAYMENT)
        add("google pay" to AppCategory.SHIPPING_PAYMENT)
        add("phonepe" to AppCategory.SHIPPING_PAYMENT)
        add("paytm" to AppCategory.SHIPPING_PAYMENT)
        add("revolut" to AppCategory.SHIPPING_PAYMENT)
        add("wise" to AppCategory.SHIPPING_PAYMENT)
        add("monzo" to AppCategory.SHIPPING_PAYMENT)
        add("doordash" to AppCategory.SHIPPING_PAYMENT)
        add("uber eats" to AppCategory.SHIPPING_PAYMENT)
        add("deliveroo" to AppCategory.SHIPPING_PAYMENT)
        add("just eat" to AppCategory.SHIPPING_PAYMENT)
        add("grubhub" to AppCategory.SHIPPING_PAYMENT)
        add("postmates" to AppCategory.SHIPPING_PAYMENT)
        add("instacart" to AppCategory.SHIPPING_PAYMENT)
        add("fedex" to AppCategory.SHIPPING_PAYMENT)
        add("usps" to AppCategory.SHIPPING_PAYMENT)
        add("dhl" to AppCategory.SHIPPING_PAYMENT)
